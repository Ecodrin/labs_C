...
void LogsAnalyzer::connect(LogsAnalyzer *analyzer, in_addr_t dst_addr, in_port_t dst_port,
    ...
    if (dst_info.connected.find(src_addr) == dst_info.connected.end()) {
        dst_info.connected[src_addr] = {
                src_addr,
                new tcp_traffic_pkg[1]{{src_port, dst_addr, dst_port, 0}},
                1
        };
        return;
    }
...
void LogsAnalyzer::get(LogsAnalyzer *analyzer, in_addr_t dst_addr, in_port_t dst_port,
                       in_addr_t src_addr, in_port_t src_port, size_t size_information) {
...
void LogsAnalyzer::post(LogsAnalyzer *analyzer, in_addr_t dst_addr, in_port_t dst_port,
                        in_addr_t src_addr, in_port_t src_port, size_t size_information) {
